...
def mostrar_marcador(ventana, puntManzanas):
    ...
    texto = fuente.render("Puntos: " + str(puntManzanas), True, (255, 255, 255))  # Crear el texto a mostrar
    pos = (1000, 50)  # Posición del texto en la ventana
    ventana.blit(texto, pos)  # Dibujar el texto en la ventana
