...
def mostrar_marcador(ventana, puntManzanas):
    ...
    texto = fuente.render("score " + str(puntManzanas), True, (255, 255, 255))  # Crear el texto a mostrar
    posicion = (960, 500)  # Posición del texto en la ventana
...
def abrir_juego():
    ...
    while True:
        ...
        if col < 0 or col > 12 or fila < 0 or fila > 12:
            ...
            cuadricula = pygame.image.load("images/cuadricula_perdido.png")
